  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (payload) {
      ...
      if (res?.data?.success) {
        ...
        toast.error(
          "Email sending failed. Please check your email and try again!",
          { position: "top-center" }
        );
      }
    }
    ...
    <>
      ...
      <section>
        <div className="relative w-full  h-96">
          ...
          <div className="relative  pt-28 bg-black bg-opacity-60 h-full w-full  text-center">
            <h2 className="block z-10 antialiased tracking-normal  font-semibold leading-[1.3] text-white mb-4 text-2xl lg:text-3xl">
              Contact Information
            </h2>
        ...
        <div className="-mt-16 mb-8 px-8 ">
          <div className="container mx-auto">
            <div className="lg:py-12 drop-shadow-xl shadow-lg shadow-black md:gap-12 gap-5 items-center flex md:flex-row flex-col md:p-0 p-5 justify-center rounded-xl border border-white bg-white   saturate-200">
              {/* <div className="my-8 grid gap-6 px-4">
                <div className="flex items-center gap-4">
                  ...
                  <p className="block antialiased  lg:text-base leading-relaxed text-inherit font-bold">
              ...
              <div className="lg:w-[30%]">
                <img
                  src="https://thumbs.dreamstime.com/b/concept-email-sending-illustrated-picture-background-232364587.jpg"
